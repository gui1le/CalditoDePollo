...
Devuelve: void
Observaciones: Ordena el arreglo reduciendo el límite superior del ciclo interno en cada iteración exterior, 
descartando las posiciones que ya se encuentran en su posición final.
*/
