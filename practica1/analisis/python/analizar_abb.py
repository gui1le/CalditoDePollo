...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_abb.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_abb.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Árbol Binario de Búsqueda (ABB)", fontsize=20, pad=14)
