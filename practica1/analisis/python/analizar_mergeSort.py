...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_mergeSort.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_mergeSort.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento MergeSort", fontsize=20, pad=14)
