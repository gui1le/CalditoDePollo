...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_Seleccion.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_Seleccion.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento Selección", fontsize=20, pad=14)
