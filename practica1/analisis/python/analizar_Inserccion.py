...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_Insercción.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_Inserccion.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento Insercción", fontsize=20, pad=14)
