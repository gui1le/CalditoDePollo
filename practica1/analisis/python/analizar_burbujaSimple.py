...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_burbujaSimple.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_burbujaSimple.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento Burbuja Simple", fontsize=20, pad=14)
