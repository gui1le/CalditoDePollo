...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_burbujaOptimizadaDos.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_burbujaOptimizadaDos.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento Burbuja Optimizada Dos", fontsize=20, pad=14)
