...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_heapSort.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_heapSort.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento HeapSort", fontsize=20, pad=14)
