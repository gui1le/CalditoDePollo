...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_QuickSort.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_QuickSort.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento QuickSort", fontsize=20, pad=14)
