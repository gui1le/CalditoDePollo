...
ARCHIVO_DATOS = CARPETA_TIEMPOS / "output" / "tiempos_Shell.txt"
ARCHIVO_GRAFICA = CARPETA_TIEMPOS / "output" / "grafica_Shell.png"
...
def crear_grafica(datos, ruta_salida):
    ...
    eje.set_title("Ordenamiento Shell", fontsize=20, pad=14)
